datasets=(
    ...
    "/share/edc/home/antonis/datasets/huggingface/flan_v1_task_ds"
...
do  
    ...
    EXP_PATH="./models/pythia/experiment_1/seed69"
    export CUDA_VISIBLE_DEVICES=0,1
    export OMP_NUM_THREADS=8
    torchrun --rdzv_backend c10d --rdzv_endpoint localhost:0 --nproc_per_node 2 \
    train_gpt.py \
       --count_tokens False \
       --model_type pythia \
