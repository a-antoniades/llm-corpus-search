...
DATASET="/share/edc/home/antonis/datasets/huggingface/merged_datasets/NLI/P_1_PQA_1_psource_False_prompt_False/dataset_1"
VALIDATION_DATASET="/share/edc/home/antonis/datasets/huggingface/merged_datasets/NLI/P_1_PQA_5_promptsource_False/dataset_1/dataset_validation.arrow"
...
DATASET="/share/edc/home/antonis/datasets/huggingface/merged_datasets/NLI/P_1_PQA_1_psource_False_prompt_False/dataset_0.1"
VALIDATION_DATASET="/share/edc/home/antonis/datasets/huggingface/merged_datasets/NLI/P_1_PQA_5_promptsource_False/dataset_1/dataset_validation.arrow"
DATASET_TYPE=$(echo "$DATASET" | awk -F/ '{print $(NF-1) "/" $NF}')
BATCH_SIZE=32
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
...
DATASET="/share/edc/home/antonis/datasets/huggingface/merged_datasets/NLI/P_1_PQA_5_psource_False_prompt_False/dataset_1"
VALIDATION_DATASET="/share/edc/home/antonis/datasets/huggingface/merged_datasets/NLI/P_1_PQA_5_promptsource_False/dataset_1/dataset_validation.arrow"
DATASET_TYPE=$(echo "$DATASET" | awk -F/ '{print $(NF-1) "/" $NF}')
BATCH_SIZE=44
